...
$('#hours-8am').val(localStorage.getItem("hours-8am"))
...
$('#hours-6').val(localStorage.getItem("hours-6"))
$('#hours-7').val(localStorage.getItem("hours-7"))
$('#hours-8pm').val(localStorage.getItem("hours-8pm"))